...
- **Lane:** Research and education workbench
- **Primary buyer:** Education or research users if a concrete workflow appears
- **First motion:** Workshop or research workflow review

## Recommended Architecture

Static demo and notebooks first, optional container service for simulations if usage justifies it.
