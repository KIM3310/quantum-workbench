# Conversion UX Model - Quantum Workbench
...
| Primary buyer or user | Students, research teams, workshop instructors, and cloud/quantum platform evaluators. |
| Value wedge | Experiment desk comparing local quantum simulation with optional managed backends. |
...
| First action | Open the portfolio-fit note, confirm the successor project, then inspect pytest passes only if this domain is relevant. |
...
- Use Experiment completion only as a discussion metric until fresh validation exists.
