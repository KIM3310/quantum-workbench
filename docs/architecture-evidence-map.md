# Architecture Guide - Quantum Workbench
...
| Why it moved back | Broad education/research tooling is less targeted than the current AI platform, governance, and ops lanes. |
