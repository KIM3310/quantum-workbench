# Service Growth Model - quantum-workbench
...
| Field | Decision |
|---|---|
| Service type | Research and education workbench |
| Primary reader or buyer | Education or research users if a concrete workflow appears. |
| Wedge | Workshop or research workflow review. |
