...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `google/gemini-3.1-pro-preview` | Quantum experiment explanations, lab notes, and provider-cost planning. |
...
OPENROUTER_HTTP_REFERER=https://quantum-workbench.pages.dev
OPENROUTER_APP_TITLE=quantum-workbench
```
