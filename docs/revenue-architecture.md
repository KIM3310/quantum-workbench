# Revenue Architecture - quantum-workbench
...
| Layer | Decision |
| --- | --- |
| Target buyer / user | education lab, developer advocate, or technical learner exploring IBM/Braket-style quantum workflows |
| Productized offer | quantum experiment workbench with provider adapters, job inspection, and educational reports |
| First paid SKU | paid lab workspace, course bundle, and provider-cost planning reports |
...
| Repo-specific launch path | Cloudflare Pages front, Hugging Face Spaces/Render for Python demo, provider API keys supplied by user, R2 for experiment exports |
